...
fun CategoryDropDown(
    ...
    ExposedDropdownMenuBox(
        ...
        onExpandedChange = { onEvent(AddPasswordItemUiEvent.ToggleIsCategoryDropdownVisible) }
    ) {
        OutlinedTextField(
            leadingIcon = {
        ...
        ExposedDropdownMenu(
            expanded = state.isCategoryDropdownVisible,
            onDismissRequest = { onEvent(AddPasswordItemUiEvent.ToggleIsCategoryDropdownVisible) },
            ...
            DropdownMenuItem(
                ...
                onClick = {
                    ...
                    onEvent(AddPasswordItemUiEvent.ToggleIsCategoryDropdownVisible)
                }
            )
